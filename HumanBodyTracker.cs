...
//            $"LocalPosition: {humanBody.transform.localPosition}\n" + " this.gameObject : " +$"{this.gameObject.ToString()} " + $"   tset 종료";
...
//            HumanBodyTrackerUI.Instance.humanBoneControllerText.text = $"Test2중입니다.(bodyTracker)" + $"{this.gameObject.name} {humanBoneController.name} Position: {humanBoneController.transform.position}\n"+
//            $"LocalPosition: {humanBoneController.transform.localPosition}";
//        }
